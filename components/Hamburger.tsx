    ...
    return (
        <div className="absolute cursor-pointer w-[50px] h-[50px] z-50 lg:hidden" onClick={() => handleClick()}>
            <div className="w-full h-full flex items-center justify-center">
                <div className={`${router.pathname === '/' ? 'hidden' : 'block'} group z-50 relative w-5 h-3 flex-col justify-between items-center flex`}>
                ...
                <div className={`${router.pathname === '/' ? 'block' : 'hidden'} group z-50 relative w-5 h-3 flex-col justify-between items-center flex`}>
