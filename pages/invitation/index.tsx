    ...
    return (
        <div className={`flex flex-col w-full h-full overflow-x-hidden z-50 ${inter.className}`}>
            ...
            <div className="w-full h-full md:px-20 xl:px-[248px] pt-20 pl-4 px-4">
                ...
                <div className="my-4">
                    St. Francis Xavier&apos;s Model UN team is dedicated to offer and incorporate FunMUN&apos;s as a viable extension to the Model UN experience. FunMUN&apos;s are committees that focus around collaboration in a fictitious, historical or hypothetical world. There are obvious limitations in our world with finite solutions, however, participating in FunMUNs give light to inconceivable circumstances, makes delegates think outside the box, and shows how the principles of Model UN can be applied creatively to challenging situations. It is the opportunity to hone your research, debate, rhetorical and lobbying skills in a creative, constructive environment.
                    <br/><br/>We are happy that we can share the Model UN experience with young, up and coming delegates from the elementary schools as well as experienced and mature delegates from our adjacent high schools. We are highly anticipating this amazing opportunity in the coming future.
                </div>
